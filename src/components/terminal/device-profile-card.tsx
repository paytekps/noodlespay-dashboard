...
export function DeviceProfileCard({ device, canEdit, token, debugCertificateSha256 }: { device: TerminalDevice; canEdit: boolean; token: string; debugCertificateSha256?: string }) {
