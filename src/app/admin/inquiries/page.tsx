...
type Inquiry = { id: string; created_at: string; inquiry_type: 'contact' | 'order_request'; status: string; full_name: string; email: string; phone: string | null; organization: string | null; plan: string | null; merchant_account_preference: string | null; processor_preference: string | null; current_processor_name: string | null; quantity: number | null; message: string | null; shipping_address: string | null; shipping_city: string | null; shipping_state: string | null; shipping_postal_code: string | null; shipping_country: string | null; admin_notes: string | null; payment_status: string };

const merchantAccountLabels: Record<string, string> = {
  existing_account: 'Use existing merchant account',
  need_merchant_account: 'Needs help obtaining a merchant account'
};
